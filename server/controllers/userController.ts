...
async function userGetRouter(req: Request, res: Response) {
  try {
...
async function userPostRouter(req: Request, res: Response) {
...
async function userLoginRouter(req: Request, res: Response) {
  try {
...
async function userProfileRouter(req: Request, res: Response) {
  try {
...
async function userProfileUpdateRouter(req: Request, res: Response) {
...
async function userDeleteRouter(req: Request, res: Response) {
  // const { username, image, password, email } = req.body;
...
async function userAuthRouter(req: Request, res: Response) {
